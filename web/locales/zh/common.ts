...
export const CommonZh: Resources['translation'] = {
  ...
  name_pattern_error: '名称必须是字母、数字或下划线，并使用下划线分隔多个单词',
  ...
  header_format_error: 'Header信息格式不正确，请输入有效的JSON格式',
  response_mapping_format_error: 'Response Mapping配置格式不正确，请输入有效的JSON格式',
  // Knowledge
  correlation_problem: '关联问题',
  please_input_question: '请输入问题',
  recall_test: '召回测试',
  recall_config: '召回配置',
  vector_search_settings: '向量检索设置',
  topk_tooltip: '基于相似度得分的前 k 个向量',
  recall_method: '召回方法',
  score_threshold: 'score阈值',
  test_question: '测试问题',
  please_input_test_question: '请输入测试问题',
  test: '测试',
  click_to_select: '点击选择，自动填入',
  recall_result: '召回结果',
  please_input: '请输入',
  // Chat
  view_reply_references: '查看回复引用',
  reply_references: '回复引用',
  click_analyze_exception: '点击分析当前异常',
  no_suitable_visualization: '暂无合适的可视化视图',
  chart_name: '名称',
  chart_value: '数值',
  // Evaluation Page
  ...
  edit_dataset: '编辑数据集',
  dataset_name: '数据集名称',
  evaluation_status: '测评状态',
  evaluation_code: '测评编码',
  evaluation_metrics: '测评指标',
  details_tooltip: '查看日志与评分',
  evaluation_result: '测评结果',
  score_details: '评分明细',
  start_evaluation: '发起评测',
  scene_type: '场景类型',
  scene_params: '场景参数',
  parallel_params: '并行参数',
  ...
  pause_reply: '暂停回复',
  clear_history: '清除历史',
  ask_anything: '可以问我任何问题',
  thinking: '思考中',
  feedback_title: '你的反馈助我进步',
  describe_problem: '描述一下具体问题或更优的答案',
  prompt: '提示词',
  // Flow Variables
  param_index_name: '参数 {index} 名称',
  verification_passed: '验证通过',
  // App Management
  get_evaluation_list_failed: '获取评估列表失败',
