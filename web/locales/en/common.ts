export const CommonEn = {
  ...
  name_pattern_error: 'Name must be letters, numbers or underscores, and use underscores to separate multiple words',
  ...
  header_format_error: 'Header format is incorrect, please enter valid JSON format',
  response_mapping_format_error: 'Response Mapping format is incorrect, please enter valid JSON format',
  // Knowledge
  correlation_problem: 'Correlation Problem',
  please_input_question: 'Please input question',
  recall_test: 'Recall Test',
  recall_config: 'Recall Config',
  ...
  please_input_test_question: 'Please input test question',
  test: 'Test',
  click_to_select: 'Click to select, auto fill',
  recall_result: 'Recall Result',
  please_input: 'Please input',
  // Chat
  view_reply_references: 'View Reply References',
  reply_references: 'Reply References',
  click_analyze_exception: 'Click to analyze current exception',
  no_suitable_visualization: 'No suitable visualization view',
  chart_name: 'Name',
  chart_value: 'Value',
  // Evaluation Page
  ...
  members: 'Members',
  return: 'Return',
  scene_evaluation: 'Scene Evaluation',
  add_success: 'Add success',
  // Mobile Chat
  ...
  thinking: 'Thinking',
  feedback_title: 'Your feedback helps me improve',
  describe_problem: 'Describe the specific problem or a better answer',
  prompt: 'Prompt',
  // Flow Variables
  param_index_name: 'Parameter {index} Name',
