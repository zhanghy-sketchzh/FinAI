...
import { Popover, Tooltip, type MenuProps } from 'antd';
...
function SideBar() {
  ...
  useEffect(() => {
    // 使用 FinAI logo，不再根据主题切换
    setLogo('/finai_logo.png');
  }, [mode]);
      ...
      >
        <div>
          <Link href='/' className='flex justify-center items-center pb-4'>
            <Image src={isMenuExpand ? logo : '/finai_logo.png'} alt='FinAI' width={40} height={40} />
          </Link>
    ...
    >
      <div>
        ...
        <Link href='/' className='flex items-center justify-center p-2 pb-4'>
          <Image src={isMenuExpand ? logo : '/finai_logo.png'} alt='FinAI' width={180} height={40} />
        </Link>
        {/* functions */}
